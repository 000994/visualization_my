...
function renderRegionHourlyDetail(data) {
  ...
  var buckets = [
    { name: "Night", from: 0, to: 5, count: 0, color: "#546e7a" },
    { name: "Morning", from: 6, to: 11, count: 0, color: "#3366cc" },
    { name: "Afternoon", from: 12, to: 17, count: 0, color: "#fb8c00" },
    { name: "Evening", from: 18, to: 23, count: 0, color: "#ab47bc" },
  ];
